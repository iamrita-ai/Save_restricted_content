...
batch_states: Dict[int, Dict[str, Any]] = {}     # 'step', 'link', 'task_id', 'is_private', 'use_user_session'
...
async def cmd_help(client: Client, msg: Message):
    text = (
        ...
        "• /settings – Set Chat ID, 'Serena' → 'Kumari', Remove Words (premium)\n"
...
async def cmd_login(client: Client, msg: Message):
    ...
    # /login free + premium dono ke liye
    if not await check_force_sub_message(msg):
        return
...
# ---------- LOGIN HANDLERS (already defined in PART 2/4) ----------
# handle_session_login, handle_phone_number, handle_phone_code, start_qr_login
# yahi functions PART 2/4 me hain – unko repeat nahi kar rahe.
...
async def cmd_batch(client: Client, msg: Message):
    ...
    # /batch free + premium dono ke liye allowed (limit alag hai)
    if not await check_force_sub_message(msg):
        return
