...
async def process_one_message(
    ...
    if has_media:
        ...
        def progress(current: int, total: int):
            # Yaha thread-safe call, event loop error nahi aayega
            try:
...
async def batch_worker_private(user_id: int, link: str, count: int, task_id: str):
    ...
    try:
        ...
        # Start message ko pin karne ki koshish
        try:
...
async def batch_worker_public(user_id: int, link: str, count: int, task_id: str):
    ...
    try:
        ...
        # Start message ko pin karne ki koshish (agar bot ke paas right hai)
        try:
