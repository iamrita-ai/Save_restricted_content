...
MAX_BATCH_LIMIT = 1000       # premium/owner ke liye
FREE_BATCH_LIMIT = 50        # free users ke liye
SLEEP_SECONDS = 12
                ...
                try:
                    ...
                    if src_msg.photo:
                        ...
                        sent = await bot.send_document(
                            chat_id=user_id,
                            document=file_path,
                            caption=text if text != "(empty_message)" else None,
                        )
