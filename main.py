...
def apply_remove_words(text: str, words: List[str]) -> str:
    ...
    for w in words:
        ...
        if not w:
            continue
        # case-insensitive whole-word remove
...
# (Login handlers already defined in PART 2/4: handle_session_login, handle_phone_number, handle_phone_code, start_qr_login)
