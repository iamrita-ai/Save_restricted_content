...
async def cmd_help(client: Client, msg: Message):
    text = (
        ...
        "💘 Login Methods:\n"
        "1️⃣ *Session String* – Pyrogram/Telethon session paste karo.\n"
...
async def cmd_settings(client: Client, msg: Message):
    ...
    await msg.reply_text("⚙️ *SERENA – Settings* ⚙️", reply_markup=kb, parse_mode="markdown")
...
async def process_one_message(
    ...
    if src_msg.media:
        ...
        try:
            # Force file under temp_dir, not temp_dir itself
