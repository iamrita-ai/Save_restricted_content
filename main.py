...
# QrCodeExpired naye Pyrogram me hota hai, purane me nahi.
# Isliye try/except se safe import:
try:
...
async def cmd_login(client: Client, msg: Message):
    ...
    text = (
        ...
        "   Note: Agar aap OTP kisi bot/chat me share karenge to Telegram is code ko block kar sakta hai.\n"
...
async def handle_phone_number(msg: Message):
    ...
    try:
        ...
        await msg.reply_text(
            ...
            "Note: Agar aap ye code kisi bot ya chat me share karenge to "
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # QR expire/invalid -> naya QR generate karein
                try:
